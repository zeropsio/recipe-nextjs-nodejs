    ...
    <div className="max-w-[1140px]">
      ...
      <div className="grid grid-cols md:grid-cols-2 font-light gap-5 md:gap-10 pt-14 px-4">
        <div className="flex flex-col gap-5">
          <Code fileLink="https://github.com/zeropsio/recipe-nextjs-nodejs/blob/main/zerops-project-import.yml" file="zerops-project-import.yml" code={importyaml} />
          <div
          className="flex flex-col py-10 h-[260px] rounded-md gap-5 px-10 border-[#E6E6E6] border"
        >
          <a
            href="https://github.com/zeropsio/recipe-nextjs-nodejs"
            target="_blank"
        ...
        <div className="flex flex-col">
          <Code fileLink="https://github.com/zeropsio/recipe-nextjs-nodejs/blob/main/zerops.yml" file="zerops.yml" code={zeropsyaml} />
        </div>
      </div>
    </div>
  );
